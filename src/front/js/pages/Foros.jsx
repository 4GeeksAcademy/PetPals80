    ...
    <div className="foros-container">
      ...
      <div className="content-section">
        <h1 className="main-title">
          <span className="pink-text">CONSEJOS Y</span>
          <br />
        ...
        <p className="welcome-text">
          Bienvenidos a la comunidad de <strong>Petpals</strong>. <br /> Este es
          el lugar donde podrás encontrar todo lo que necesitas para el día a
          día con tu mascota. Entra en un foro y habla con gente de todo el
          mundo, sigue sus perfiles y acompañanos en esta nueva aventura. No
          olvides visitar nuestras secciones secundarias para saber más sobre
          los cuidados, salud, alimentaición y bienestar de tus pequeños.
        </p>
      </div>
