...
const AlimentosArtropodos = () => {
  ...
  const FORUM_ID = FORUM_IDS.ARTROPODOS.ALIMENTO;
      ...
      <div className="subforum-content">
        <div className="content-section">
          <div className="image-section">
            <img src={artropodos} alt="Artrópodos" className="perros-image" />
          </div>
          <h1 className="main-title">Alimento</h1>
        </div>
...
export default AlimentosArtropodos;