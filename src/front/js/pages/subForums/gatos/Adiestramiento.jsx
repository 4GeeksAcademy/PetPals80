...
const AdiestramientoGatos = () => {
  ...
  const FORUM_ID = FORUM_IDS.GATOS.ADIESTRAMIENTO;
      ...
      <div className="subforum-content">
        <div className="content-section">
          <div className="image-section">
            <img src={gatos} alt="Gatos" className="perros-image" />
          </div>
          <h1 className="main-title">Adiestramiento</h1>
        </div>
...
export default AdiestramientoGatos;